...
#import "Videotasche.h"
#import "SHK.h"
#import "MKInfoPanel.h"
@implementation Videotasche
...
-(void) grabRSSFeed {
    ...
    NSURL *url = [NSURL URLWithString: @"http://taschencasts.de/?feed=rss2&cat=6"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:fileName]) {
        ...
        movieView = [[MPMoviePlayerViewController alloc] initWithContentURL: [NSURL URLWithString: fileName]];
        //[movieView retain];
...
{
	NSURL *url = [NSURL URLWithString:@"http://itunes.apple.com/de/podcast/videotasche/id428086265"];
	SHKItem *item = [SHKItem URL:url title:@"Die Videotasche"];
